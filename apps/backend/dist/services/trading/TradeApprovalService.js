...
import { appendTrade } from '../store/PaperStore.js';
export class TradeApprovalService {
    async approvePaper(plan, confirmations) {
        ...
        return { id: nanoid(), status: 'FILLED', planId: plan.id, qty, avgPrice: price, ts: new Date().toISOString() };
    }
}
