...
const plan:any={ id:'p', analysisId:'a', symbol:'BTCUSDT', timeframe:'1h', capital:100000, entries:[{side:'BUY',qtyPct:0.02,rationale:'x'}], exitRules:{stopLossPct:0.02,takeProfitPct:0.04}};
